...
@Component({
    ...
    <ion-col col-8 *ngIf="items && items.length > 0" (click)="selectProduct(items)">
  ...
  <ion-row *ngIf="items && items.length === 2">
    <ion-col col-6 *ngIf="items && items.length > 0" (click)="selectProduct(items)">
      <img src="{{items[0].image}}">
      <p class="p-margin-top-50">{{items[0].name}} {{items[0].price}}</p>
    </ion-col>
    <ion-col col-6 *ngIf="items && items.length > 1" (click)="selectProduct(items)">
  ...
  <ion-row *ngIf="items && items.length === 3">
    ...
    <ion-col col-6>
      <ion-row>
        ...
        <ion-col col-6 *ngIf="items && items.length > 2" (click)="selectProduct(items)">
  ...
  <ion-row *ngIf="items && items.length === 4">
    ...
    <ion-col col-6>
      ...
      <ion-row>
        <ion-col col-6 *ngIf="items && items.length > 3" (click)="selectProduct(items)">
    ...
    <ion-row *ngIf="items && items.length > 4">
      ...
      <ion-col col-6>
        ...
        <ion-row>
          ...
          <ion-col col-6 *ngIf="items && items.length > 4" (click)="selectProduct(items)">
