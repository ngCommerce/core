...
@Component({
    ...
    <ion-row>
      <ion-col col-6 *ngIf="items && items.length > 0">
        ...
        <p class="p-price">{{items[0].price}}</p>        
      </ion-col>
      <ion-col col-6>
        <ion-row>
